...
\lstset{
    literate=%
        % Caratteri italiani con accenti acuti
        {á}{{\'a}}1
        {é}{{\'e}}1
        {í}{{\'i}}1
        {ó}{{\'o}}1
        ...
        {Ó}{{\'O}}1
        {Ú}{{\'U}}1
        % Caratteri italiani con accenti gravi
        {à}{{\`a}}1
        {è}{{\`e}}1
        {ì}{{\`i}}1
        {ò}{{\`o}}1
        ...
        {Ò}{{\`O}}1
        {Ù}{{\`U}}1
        % Altri caratteri italiani
        {ç}{{\c{c}}}1
        {Ç}{{\c{C}}}1
        % Caratteri cechi (dal tuo codice originale)
        {ý}{{\'y}}1
        {ě}{{\v{e}}}1
        {š}{{\v{s}}}1
        {č}{{\v{c}}}1
...
% per le accentate
\definecolor{vscKeyword}{HTML}{0000FF}    % blu VSCode
\definecolor{vscString}{HTML}{A31515}     % rosso stringhe
\definecolor{vscNumber}{HTML}{098658}     % verde numeri
\definecolor{vscBool}{HTML}{0000FF}       % stesso dei keyword
\definecolor{vscPunct}{HTML}{000000}      % simboli neri
\definecolor{vscId}{HTML}{795E26}         % chiavi/identificatori
...
\lstdefinelanguage{jsonVS}{
   ...
   *{:}{{{\color{vscPunct}:}}}{1}
    ...
    {]}{{{\color{vscPunct}]}}}{1}
    % numeri
    {0}{{{\color{vscNumber}0}}}{1} {1}{{{\color{vscNumber}1}}}{1}
    {2}{{{\color{vscNumber}2}}}{1} {3}{{{\color{vscNumber}3}}}{1}
    {4}{{{\color{vscNumber}4}}}{1} {5}{{{\color{vscNumber}5}}}{1}
    {6}{{{\color{vscNumber}6}}}{1} {7}{{{\color{vscNumber}7}}}{1}
    {8}{{{\color{vscNumber}8}}}{1} {9}{{{\color{vscNumber}9}}}{1}
}
\lstdefinestyle{jsonVS}{
  language=jsonVS,
  basicstyle=\small\ttfamily\color{vscId},
