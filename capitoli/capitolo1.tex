\section{La Cybersecurity nelle Startup fintech}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{fintech_services_categories}
...
\subsection{Banche Tradizionali vs. Startup fintech}
...
Un aspetto cruciale di distinzione risiede proprio nell'approc\allowbreak{}cio alla cyber\allowbreak{}security.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item La pressione competitiva per innovare rapidamente, superando gli operatori tradizionali, può incentivare cicli di sviluppo accelerati a scapito della robustezza della sicurezza dei sistemi e delle tecnologie sottostanti \cite{dasawat2023cyber}.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        (cloud computing, Application Programming Interfaces (\textit{API}) aperte, intelligenza artificiale, blockchain)\allowbreak{} %
...
\subsection{Vettori di Attacco e Minacce nel fintech}
...
\begin{itemize}
    ...
    \item \textbf{Sfruttamento di Vulnerabilità Software e Zero-Day}: Le startup, per la rapidità di sviluppo, potrebbero non avere processi di gestione delle patch (\textit{patch management}) e di valutazione delle vulnerabilità (\textit{vulnerability assessment}) altrettanto maturi quanto aziende più strutturate. Questo le espone a rischi derivanti da vulnerabilità note o, nel peggiore dei casi, da quelle non ancora divulgate (definite \textit{zero-day}).
\end{itemize}
