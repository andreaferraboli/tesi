...
di sicurezza.
\item[Capitolo 4 – Progettazione e Implementazione \allowbreak{}Avanzata della \allowbreak{}Sicurezza \allowbreak{}delle 
\allowbreak{}Identità e degli Accessi (IAM) in AWS] Questo capitolo si concentra sull'implementazione 
...
\item[Capitolo 5 – Architettura di Rete Sicura e Protezione dei \allowbreak{}Servizi Applicativi 
\allowbreak{}su AWS per fintech] Il quinto capitolo descrive la progettazione di un'architettura 
di rete sicura mediante VPC, gruppi di sicurezza e controlli di accesso avanzati.
\item[Capitolo 6 – Implementazione di un Honeypot in un'Infrastruttura AWS per 
\allowbreak{}Startup fintech] L'ultimo capitolo tecnico presenta l'implementazione di un 
sistema honeypot su AWS per il rilevamento proattivo delle minacce, includendo 
analisi dei costi e test di efficacia.
\item[Capitolo 7 – Conclusioni] Il capitolo finale riassume i risultati raggiunti 
\allowbreak{}e presenta considerazioni sulle prospettive future per la sicurezza delle 
...
\chapter{Conclusioni e Prospettive Future per la Cybersecurity nelle Startup fintech}
